namespace SocialMedia.INFRASTRUCTURE.Services
{
    ...
    public class PasswordSevice : IPasswordService
    {
        private readonly PasswordOptions _options;

        public PasswordSevice(IOptions<PasswordOptions> options)
        {
        ...
        public bool Check(string hash, string password)
        {
            ...
            if (parts.Length !=3) 
            {
                throw new FormatException("Formato inesperado para el Hash");
            }
